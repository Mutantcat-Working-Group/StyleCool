...
- 带 `token`、`q`、`cat` 参数时返回样式库 JSON 结果。
- 无参数时渲染 HTML 文档页，内置中英文切换。

#### 样式示例画廊 `/example`

- 100 个示例，每个含完整 HTML、缩略图与可直接复制的生成提示词。
- 支持 `?q=` 关键词检索与 `?p=` 分页。

#### 样式库数据

- 四类平台分类：网站、桌面、小程序、手机。
- 数据文件与代码分离，改 JSON 即生效。
